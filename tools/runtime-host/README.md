...
top-level CMake build. iPolars uses the compatible general-author OPP API 0.4
profile; iGRIB and iWeatherRouting use the universal OPP API 0.5 specialist
worlds.
